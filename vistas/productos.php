    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-warning py-1">
                ...
                <button type="button" class="btn btn-outline-dark text-blck border-0 fs-5" data-bs-dismiss="modal" id="btnCerrarModal">
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" novalidate >
                    ...
                    <div class="row">
                        ...
                        <button type="button" style="width:170px;" class="btn btn-success mt-3 mx-2"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-warning py-2">
                ...
                <button type="button" class="btn-close text-black fs-6" data-bs-dismiss="modal" aria-label="Close"
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <label for="" class="form-label text-success">Nuevo Stock: <span id="stock_NuevoStock"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" id="btnGuardarNuevorStock">Guardar</button>
            </div>
