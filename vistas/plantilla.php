...
if (isset($_GET["cerrar_sesion"]) && $_GET["cerrar_sesion"] == 1) {
    ...
    session_destroy();
         ...
         echo '
            <script>
                window.location = "http://localhost/sis_ventas_abarrotes/";
            </script>';
        }
...
<head>
    ...
    <title>Cremeria San Juan</title>

    <link rel="shortcut icon" href="vistas/assets/dist/img/cremeria.png" type="image/x-icon">
